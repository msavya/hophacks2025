    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-green-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-gray-900">RoundUp Dashboard</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-green-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600">${userStats.totalDonated}</p>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-emerald-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-emerald-600">${userStats.thisMonth}</p>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-lime-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Streak</p>
                <p className="text-3xl font-bold text-lime-600">{userStats.currentStreak} days</p>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-green-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600">{userStats.peopleHelped}</p>
              </div>
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
          ...
          <div className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-green-600">{userStats.charitiesSupported}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Characters Unlocked</span>
                        <span className="font-semibold text-green-600">{userStats.charactersUnlocked}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Badges Earned</span>
                        <span className="font-semibold text-green-600">{userStats.badgesEarned}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-2">${userStats.nextMilestone}</div>
            ...
            {activeTab === 'characters' && (
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-100 to-emerald-100 p-6 rounded-xl border-2 border-dashed border-green-300">
                  <div className="text-center">
                    <Gift className="w-12 h-12 mx-auto text-green-600 mb-3" />
